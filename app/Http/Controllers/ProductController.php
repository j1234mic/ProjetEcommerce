...
class ProductController extends Controller
{
    ...
    public function saveproduct(Request $request)
    {
        ...
        $product->status = 1;
        $product->save();
        return back()->with('status', 'The product is successfully saved !!');
    }
    ...
    {
        $this->validate($request, ['product_name' => 'required', 'product_price' => 'required', 'product_category' => 'required', 'product_image' => 'image|nullable|max:800']);
